...
enum Tickers : uint32_t {
  ...
  BLOCK_NO_HASH_INDEX,
  BLOCK_HASH_INDEX,
  BLOCK_HASH_INDEX_CANCELLED,
  BLOCK_HASH_INDEX_VALID,
  BLOCK_HASH_INDEX_BUCKETS,
  BLOCK_HASH_INDEX_BUCKETS_CANCELLED,
  BLOCK_HASH_INDEX_BUCKETS_VALID,
  BLOCK_PERFECT_HASH_INDEX,
#endif
...
#ifdef CSC494_MPH_STATISTICS
  TABLE_HASH_ENTRY_COUNT,
  TABLE_HASH_SIZE,
  TABLE_HASH_CANCELLED,
  TABLE_HASH_VALID,
  TABLE_HASH_BUCKET_COUNT,
  TABLE_HASH_BUCKET_CANCELLED,
  TABLE_HASH_BUCKET_VALID,

  TABLE_PERFECT_HASH_IS_PERFECT,
  TABLE_PERFECT_HASH_ENTRY_COUNT,
  TABLE_PERFECT_HASH_NUM_LEVEL_COUNT,
  TABLE_PERFECT_HASH_BIT_V_SIZE,
  TABLE_PERFECT_HASH_RANK_P_SIZE,
  TABLE_PERFECT_HASH_NUM_RESTART,
  TABLE_PERFECT_HASH_SIZES,
  TABLE_PERFECT_HASH_SIZES_EST,
  TABLE_PERFECT_HASH_SEEK_TIME,
#endif
